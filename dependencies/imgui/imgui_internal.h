...
#pragma clang diagnostic ignored "-Wunused-functions"                // for stb_textedit.h
#pragma clang diagnostic ignored "-Wmissing-prototypes"             // for stb_textedit.h
#pragma clang diagnostic ignored "-Wold-style-cast"
#pragma clang diagnostic ignored "-Wzero-as-null-pointer-constant"
#pragma clang diagnostic ignored "-Wdouble-promotion"
#pragma clang diagnostic ignored "-Wimplicit-int-float-conversion"  // warning: implicit conversion from 'xxx' to 'float' may lose precision
#pragma clang diagnostic ignored "-Wmissing-noreturn"               // warning: functions 'xxx' could be declared with attribute 'noreturn'
...
typedef int ImGuiActivateFlags;         // -> enum ImGuiActivateFlags_      // Flags: for navigation/focus functions (will be for ActivateItem() later)
...
// ImDrawList: Helper functions to calculate a circle's segment count given its radius and a "maximum error" value.
...
enum ImGuiScrollFlags_
{
    ...
    ImGuiScrollFlags_NoScrollParent         = 1 << 6,       // Disable forwarding scrolling to parent window if required to keep item/rect visible (only scroll window the functions was applied to).
...
struct ImGuiContext
{
    ...
    int                     LogDepthToExpandDefault;            // Default/stored value for LogDepthMaxExpand if not specified in the LogXXX functions call.
...
namespace ImGui
{
    ...
    IMGUI_API void          Shutdown();    // Since 1.60 this is a _private_ functions. You can call DestroyContext() to destroy the context created by CreateContext().
...
//#endif
    ...
    IMGUI_API void          MarkItemEdited(ImGuiID id);     // Mark data associated to given item as "edited", used by IsItemDeactivatedAfterEdit() functions.
